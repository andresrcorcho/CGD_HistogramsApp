...
Unchecked            |  Checked
:-------------------------:|:-------------------------:
<img src="./screenshots/labelDisab.png" alt="Drawing" style="width: 300px;/" >  |  <img src="./screenshots/labelEnab.png" alt="Drawing" style="width: 300px;/">

### 11. "Adjust"
If this option is set as "Checked", the size of the red circle that marks the detected peaks is set to a fraction of the  global font size specified in the "Text Size" slider. If unchecked, the size will be always the default = .

Unchecked            |  Checked
:-------------------------:|:-------------------------:
<img src="./screenshots/labelDisab.png" alt="Drawing" style="width: 300px;/" >  |  <img src="./screenshots/adjustC.png" alt="Drawing" style="width: 300px;/">

img comparing reduced stuff...and default o
...
Unchecked            |  Checked
:-------------------------:|:-------------------------:
<img src="./screenshots/sharedDis.png" alt="Drawing" style="width: 300px;/" >  |  <img src="./screenshots/sharedEnab.png" alt="Drawing" style="width: 300px;/">
...
### 16. "GeoColors"
If this option is set as "Checked", the colors of the UGS geological timne scale will be displayed in the background of the screen as vertical bars. This is ideal to easily constrain the timing of tectonic events related to peaks.

Unchecked            |  Checked
:-------------------------:|:-------------------------:
<img src="./screenshots/peakDetectorDis.png" alt="Drawing" style="width: 300px;/" >  |  <img src="./screenshots/peakDetectorEna.png" alt="Drawing" style="width: 300px;/">
