...
class Ui_Geochronology(object):
    def setupUi(self, Geochronology):
        ...
        self.gridLayout_4.addWidget(self.groupBox_4, 10, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.groupBox_2, 7, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.TSize, 9, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.BW, 1, 3, 1, 1)
        self.savepng = QtWidgets.QCheckBox(self.Parameters)
        self.savepng.setObjectName("savepng")
        self.gridLayout_4.addWidget(self.savepng, 3, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.geoScale, 8, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.YAxisTicks, 8, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.savepdf, 2, 3, 1, 1)
        self.Minin = QtWidgets.QLineEdit(self.Parameters)
        self.Minin.setObjectName("Minin")
        self.gridLayout_4.addWidget(self.Minin, 2, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.Maxi, 3, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.bins, 4, 1, 1, 1)
        self.tsize = QtWidgets.QLabel(self.Parameters)
        self.tsize.setText("")
        self.tsize.setObjectName("tsize")
        self.gridLayout_4.addWidget(self.tsize, 9, 3, 1, 1)
        self.TR = QtWidgets.QLabel(self.Parameters)
        self.TR.setText("")
        self.TR.setObjectName("TR")
        self.gridLayout_4.addWidget(self.TR, 0, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.sharedXY, 7, 3, 1, 1)
        ...
        self.Bw.setObjectName("Bw")
        self.gridLayout_4.addWidget(self.Bw, 1, 1, 1, 1)
        self.DecimalPeaks = QtWidgets.QCheckBox(self.Parameters)
        self.DecimalPeaks.setObjectName("DecimalPeaks")
        self.gridLayout_4.addWidget(self.DecimalPeaks, 10, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.peakvalue, 5, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.delta, 5, 1, 1, 2)
        self.tratio = QtWidgets.QLineEdit(self.Parameters)
        self.tratio.setObjectName("tratio")
        self.gridLayout_4.addWidget(self.tratio, 0, 1, 1, 1)
        ...
        self.actionDataSets.setCheckable(False)
        self.actionDataSets.setObjectName("actionDataSets")
        self.versionInfo = QtWidgets.QAction(Geochronology)
        self.versionInfo.setObjectName("versionInfo")
        self.actionSave_Current = QtWidgets.QAction(Geochronology)
        self.actionSave_Current.setObjectName("actionSave_Current")
        self.actionExit = QtWidgets.QAction(Geochronology)
        self.actionExit.setObjectName("actionExit")
        self.menuAbout.addAction(self.versionInfo)
    ...
    def retranslateUi(self, Geochronology):
        ...
        self.ticksadjust.setText(_translate("Geochronology", "Ticks interval"))
        ...
        self.tratio.setText(_translate("Geochronology", "50"))
        ...
        self.versionInfo.setText(_translate("Geochronology", "Version"))
        self.actionSave_Current.setText(_translate("Geochronology", "Save Current"))
        self.actionExit.setText(_translate("Geochronology", "Exit"))
